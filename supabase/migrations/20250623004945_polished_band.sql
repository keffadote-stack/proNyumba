...
-- Create unique index for property views to prevent duplicates within 1 hour
CREATE UNIQUE INDEX IF NOT EXISTS idx_property_views_unique_hourly 
ON property_views (property_id, viewer_id, date_trunc('hour', viewed_at))
...
BEGIN
  ...
  ON CONFLICT ON CONSTRAINT idx_property_views_unique_hourly DO NOTHING;
